...
const GUARD_SOURCE: &str = "crates/cuboid-core/tests/source_separation.rs";
...
const SECTION_NAME_ALLOWLIST: [&str; 2] = [
    "crates/cuboid-core/src/config.rs",
    "crates/cuboid-core/tests/config_public.rs",
];
...
const REQUIRED_COVERAGE: [&str; 7] = [
    "Cargo.toml",
    "README.md",
    "crates/cuboid-app/cuboid.rc",
    "crates/cuboid-core/src/config.rs",
    "packaging/wix/Cuboid.wxs",
    "scripts/package.ps1",
    GUARD_SOURCE,
];
